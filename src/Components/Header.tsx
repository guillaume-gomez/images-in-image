  ...
  return (
    <div className="navbar bg-primary text-primary-content gap-2">
      <div className="flex justify-between w-full">
        ...
        <a className="btn btn-ghost" href="https://github.com/guillaume-gomez/images-in-image">
          <svg
            width="18"
            height="18"
            className="h-5 w-5"
          ...
          >
            ...
            <path d="M6 31.2155C6.89887 31.3254 7.56554 31.7387 8 32.4554C8.65169 33.5303 11.0742 37.518 13.8251 37.518C15.6591 37.518 17.0515 37.518 18.0024 37.518" stroke="currentColor" stroke-width="4" stroke-linecap="butt">
